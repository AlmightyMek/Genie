...
class GenieClient():
    ...
    def __init__(self,testbed):
        ...
        self.testbed = testbed.connect(log_stdout=False)
    ...
    #Make sure this works               
                if local_interface in management_interface: #Check if the local interface is a management interface
                    interface_desc=(f'Conneted to the backbone device {remote_device_hostname} via its 
                    {remote_device_interface} interface')  # if so set this desc
